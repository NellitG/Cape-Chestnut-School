    ...
    <div class="!flex h-[90vh] w-full items-center justify-between px-0">
      ...
      <div class="container mx-auto lg:mt-0">
        ...
        <div class="grid grid-cols-12 text-start lg:text-start">
          <div
            class="relative flex flex-col bg-clip-border lg:ml-20 text-gray-700 px-16 py-10 border border-white shadow-lg col-span-full rounded-xl bg-white shadow-black/10 backdrop-blur-sm backdrop-saturate-200 xl:col-span-8 mt-28"
          >
            <h1
              class="tracking-normal font-semibold text-gray-950 text-5xl !leading-snug lg:text-6xl"
            >
              Cape Chestnut School
            </h1>
            <p
              class="antialiased font-sans text-2xl font-semibold leading-relaxed text-inherit mb-10 mt-6 text-gray-950"
            >
            ...
            <div class="flex justify-center gap-4 mb-8 lg:justify-start">
              ...
              <button
                class="align-middle select-none font-sans font-semibold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg hover:bg-green-500 text-black border-2 border-green-500 shadow-md shadow-primary-color/10 hover:shadow-lg hover:shadow-primary-color/10 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none"
                type="button"
              >
                contact us
                </button>
              ...
              <router-link to="/academics">
                <button
                class="align-middle select-none font-semibold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg border-green-500 border-2 hover:bg-green-500 text-black hover:opacity-75 focus:ring focus:ring-gray-300 active:opacity-[0.85]"
                type="button"
              >
                read more
              </button>

<template>
  ...
  <div class="container mx-auto relative z-10 mt-24 py-10">
    <div class="grid grid-cols-12 text-center lg:text-start">
      ...
      >
        <h1
          class="tracking-normal font-semibold text-white lg:text-gray-950 text-5xl !leading-snug lg:text-6xl"
        >
          Cape Chestnut School
        </h1>
        <p
          class="antialiased font-sans text-2xl font-semibold leading-relaxed text-inherit mb-10 mt-6 text-white lg:text-gray-950"
        >
